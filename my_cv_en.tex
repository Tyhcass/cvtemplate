...
\tightlist
\item
  \emph{Comparative Politics}: Internet politics, political
  communication, authoritarian responsiveness.
\item
  \emph{Political Methodology}: Spatial analysis, factor analysis.
\item
...
\tightlist
\item
  Analysis \& Programming: R, Stata, Python.
\item
